...
- Exibe progresso animado e estado ocupado acessível durante operações.
- Torna erros mais visíveis sem interromper o fluxo com janelas nativas.
- Adiciona um estado vazio orientativo para a primeira utilização.
